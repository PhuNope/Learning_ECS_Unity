...
namespace HelloCube.StateChange {
    public partial struct SetStateSystem : ISystem {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            else if (config.Mode == Mode.STRUCTURAL_CHAGE) {
                new AddSpinJob() {
                    RadiusSq = radiusSq,
                    Hit = hit.Value,
            ...
            var elapse = (after - before) * conversionRatio.Numerator / conversionRatio.Denominator;
            SystemAPI.GetSingletonRW<StateChangeProfilerModule.FrameData>().ValueRW.SetStatePerf = elapse;
#endif
        }
    }
