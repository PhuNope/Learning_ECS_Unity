...
namespace HelloCube.StateChange {
    ...
    public class StateChangeProfilerModule : ProfilerModule {
        ...
        private static readonly string s_SpinPerfCounterLabel = "Spin System";
        private static readonly string s_SetStatePerfCounterLabel = "SetState System";

        private static readonly ProfilerCounterValue<long> s_SpinPerfCounterValue = new(
        ...
        private static readonly ProfilerCounterDescriptor[] k_ChartCounters = {
